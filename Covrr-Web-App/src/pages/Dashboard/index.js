    ...
    <div className="dashboard_page">
      <div className="flex justify-between space-x-4 bg-cardBackground p-[15px] px-3 mr-[-15px] ml-[-19px] mt-[-19px] border-b border-border">
        ...
        <div className="ml-auto flex space-x-2">
          <button className="px-3 py-2 bg-muted2 border border-border rounded-full flex items-center">
            <CalendarIcon className="h-5 w-5 fill-none text-primary" />
          </button>
          <button className="px-6 py-2 bg-muted2 border border-border rounded-full flex font-semibold items-center">
            <ArrowDownTrayIcon className="h-5 w-5 mr-2" /> Reports
          </button>
        </div>
      </div>
      {
