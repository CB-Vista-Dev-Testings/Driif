...
const FleetAnalytics = () => {
  ...
  const fleetSafetyScoreOptions = {
    ...
    series: [
      ...[0, 21, 32].map((rotation, index) => ({
        ...
        data: [
          { value: 400, name: "Distracted", itemStyle: { color: "#2B72D1" } },
          { value: 300, name: "Over Speeding", itemStyle: { color: "#149CD2" } },
          { value: 200, name: "Harsh Acceleration", itemStyle: { color: "#FFB91F" } },
          { value: 150, name: "Crash detection", itemStyle: { color: "#FF1F79" } },
          { value: 100, name: "Harsh Breaking", itemStyle: { color: "#14D279" } },
          { value: 80, name: "Smoking", itemStyle: { color: "#FF661F" } },
        ],
      })),
    ],
  };
  ...
  const fleetAnalyticsOptions = {
    ...
    series: [
      ...[0, 21, 32].map((rotation, index) => ({
        ...
        data: [
          { value: 2900, name: "Running", itemStyle: { color: "#14D279" } },
          { value: 2300, name: "Parked", itemStyle: { color: "#FFB91F" } },
          { value: 2300, name: "Inactive", itemStyle: { color: "#FF1F79" } },
        ],
      })),
    ],
  };
    ...
    series: [
      ...[0, 21, 32].map((rotation, index) => ({
        ...
        data: [
          ...
          { value: 2300, name: "Available", itemStyle: { color: "#FFB91F" } },
          { value: 2300, name: "Inactive", itemStyle: { color: "#FF1F79" } },
        ],
      })),
    ],
  ...
  return (
    <>
      <div className="grid grid-cols-3 xl:grid-cols-5 gap-4 mt-6">
        {[
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 mt-6 cursor-pointer">
        <div
          onClick={() => setSelectedInfo("fleet_safety")}
          className={`md:col-span-2 lg:col-span-1 p-6 pb-0 border border-border rounded-xl bg-cardBackground dark:bg-gradient2 cursor-pointer
        ...
        >
          <h3 className="title-text mb-[-30px]">Fleet Safety Score</h3>
          <ReactECharts option={fleetSafetyScoreOptions} className="mb-[-25px] mt-[-10px] cursor-pointer" />
        </div>
        <div
          onClick={() => setSelectedInfo("fleet_analytics")}
          className={`p-6 pb-0 border border-border rounded-xl bg-cardBackground dark:bg-gradient2 cursor-pointer
        ...
        >
          <h3 className="title-text mb-[-30px]">Fleet Analytics</h3>
          <ReactECharts option={fleetAnalyticsOptions} className="mb-[-25px] mt-[-10px]" />
        </div>
        <div
          onClick={() => setSelectedInfo("charger_analytics")}
          className={`p-6 pb-0 border border-border rounded-xl bg-cardBackground dark:bg-gradient2 cursor-pointer
        ...
        >
          <h3 className="title-text mb-[-30px]">Chargers Analytics</h3>
          <ReactECharts option={chargerAnalyticsOptions} className="mb-[-25px] mt-[-10px] cursor-pointer" />
        </div>
      </div>
        ...
        <>
          <div key="fleet_safety" className="animate-fadeIn p-6 pt-4 pb-0 border border-border rounded-xl bg-cardBackground shadow-[0px_0px_15px_5px_#00000005] mt-6">
            <div className="flex justify-between items-center">
              <h3 className="title-text">Fleet Safety Score</h3>
            ...
            <div key="fleet_analytics" className="animate-fadeIn p-6 pt-4 pb-0 border border-border rounded-xl bg-cardBackground shadow-[0px_0px_15px_5px_#00000005] mt-6">
              <div className="flex justify-between items-center">
                <div className="flex items-center border border-border rounded-md p-[2px] bg-muted1 mb-2 relative">
                  <div
                    className={`absolute top-0 left-0 h-full w-1/2 bg-cardBackground shadow-sm border border-border rounded-md transition-transform duration-300 ease-in-out my-[0.5px] ${
                      selectedFleetAnalytics === "fleet_report" ? "transform translate-x-0" : "transform translate-x-full"
                    }`}
                  ></div>
                  <button
                    className={`w-[200px] whitespace-nowrap py-2 rounded-lg text-text1 text-[14px] relative z-10 ${selectedFleetAnalytics === "fleet_report" ? "font-semibold" : ""}`}
                    onClick={() => setSelectedFleetAnalytics("fleet_report")}
                  >
                    Fleet Utilization reports
                  </button>
                  <button
                    className={`w-[200px] whitespace-nowrap py-2 rounded-lg text-text1 text-[14px] relative z-10 ${selectedFleetAnalytics === "cost_analytics" ? "font-semibold" : ""}`}
                    onClick={() => setSelectedFleetAnalytics("cost_analytics")}
                  >
                    Cost Analysis
                  </button>
                </div>
              </div>
              {(selectedFleetAnalytics === "fleet_report" && <ReactECharts option={areaChartOptions} className="mt-6 w-full" />) ||
                (selectedFleetAnalytics === "cost_analytics" && <ReactECharts option={areaChartOptions} className="mt-6 w-full" />)}
            </div>
          </>
        )) ||
